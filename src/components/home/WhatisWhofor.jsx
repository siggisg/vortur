...
function WhatisWhofor({ openPopup }) {
  ...
  //const [showPopup, setShowPopup] = useState(false);
    ...
    return (
        <section className="whatiswhofor">
            <h1 className='whatiswhofor-headline'>Fyrir hverja er Swift?</h1>
            <p className='whatiswhofor-text'>Swift vörtumeðferð er fyrir alla nema eftirfarandi:</p>
  ...
  <li>Fólk með mjög skert ónæmiskerfi (metið af sérfræðingi).</li>
            ...
            <button className='whatiswhofor-button' onClick={openPopup}>
                Bóka núna
            </button>
